...
The EVM execution environment is equivalent to the EVM specs for Ethereum mainnet, running a modified version of Geth 1.10 rebased to include the newly added OPCodes like Push0 and EIP-1559 for standard gasfee management or to provide services like debug_trace() API.
